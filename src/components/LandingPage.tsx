      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <p className="text-gray-600 font-medium mb-6">Trusted by students & professionals worldwide</p>
            
            <div className="flex items-center justify-center gap-8 mb-8 flex-wrap">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="h-12 w-32 bg-gray-200 rounded flex items-center justify-center opacity-60">
